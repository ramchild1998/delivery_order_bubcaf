        ...
        <table class="table table-borderless" id="" cellspacing="0">
            <tbody>
                ...
                <tr style="">
                    <td><b>Vendor</b></td>
                    <td><b>:</b></td>
                    <td><input id="pic_name" type="text" class="form-control" name="name" value="{{$office->vendor_id}}"></td>
                </tr>
                <tr style="">
                    <td><b>PIC Contact Number</b></td>
                    <td><b>:</b></td>
                    <td><input id="pic_contact_num" type="text" class="form-control" name="name" value="{{$office->pic_contact_num}}"></td>
                </tr>
                <tr style="">
                    <td><b>Status</b></td>
                    <td><b>:</b></td>
                    <td>
                        <label class="switch">
                            <input id="Uhui" type="checkbox" name="is_active" {{$office->is_active ? 'checked' : ''}} onchange="toggleCheckbox(this)">
