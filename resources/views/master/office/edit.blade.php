...
<div class="page-heading">
    <h1 class="h3 mb-2 text-gray-800">Edit Office</h1>
        ...
        <table class="table table-borderless" id="" cellspacing="0">
                <tbody>
                    <tr style="">
                        ...
                        <td><b>Zip Code</b></td>
                        <td><b>:</b></td>
                        <td><input id="zip_code" type="text" class="form-control" name="zip_code" value="{{$office->zip_code}}"></td>
                    </tr>
                    <tr style="">
                        <td><b>Vendor</b></td>
                        <td><b>:</b></td>
                    ...
                    <td><b>Street</b></td>
                        ...
                        <td><b>:</b></td>
                        <td><input id="pic_contact_number" type="text" class="form-control" name="pic_contact_number" value="{{$office->pic_contact_number}}"></td>
                    </tr>
                    <tr style="">
                    <td><b>Provinsi</b></td>
                        <td><b>:</b></td>
                        ...
                        <input id="Uhui" type="checkbox" name="is_active" data-old_value="old_value" {{$office->is_active ? 'checked' : ''}} onchange="toggleCheckbox(this)">
