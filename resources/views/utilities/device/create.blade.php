...
<div class="page-heading">
    <h1 class="h3 mb-2 text-gray-800">Create Device</h1>
...
<div class="card shadow mb-4">
    <div class="card-body">
        <form action="{{route('device.create')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <table class="table table-borderless" id="" cellspacing="0">
                <tbody>
                    ...
                    <tr style="">
                        ...
                        <td><b>:</b></td>
                        <td><input id="device_id" type="text" class="form-control" name="device_id"></td>
                    </tr>
                    <tr style="">
                        <td><b>Merk</b></td>
                        <td><b>:</b></td>
                        <td><input id="merk" type="text" class="form-control" name="merk"></td>
                    </tr>
                    <tr style="">
                        <td><b>Tipe</b></td>
                        <td><b>:</b></td>
                        <td><input id="type" type="text" class="form-control" name="type"></td>
                    </tr>
                    <tr style="">
                        <td><b>Status</b></td>
                        <td><b>:</b></td>
